...
##### **Criterios a), e), f), g), h)**
```
AMPLIADO! Fecha de Entrega: xx/xx/2025 - 14:00:00
```
...
##### **Criterios a), e), f), g), h)**
```
Fecha de Entrega: xx/xx/2025 - 14:00:00
```
...
```
Fecha de Examen: xx/xx/2025 - 17:45:00
```
...
Creado por José David Vela Castro e inspirado en el gran trabajo de [Daniel Pérez Rodríguez](https://twitter.com/daniteleco) y de [José Luis González Sánchez](https://github.com/joseluisgs/ProgServiciosProcesos-00-2021-2022)
